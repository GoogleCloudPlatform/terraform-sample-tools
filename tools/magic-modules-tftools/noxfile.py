...
FLAKE8_COMMON_ARGS = [
    ...
    "--exclude=.nox,.cache,env,lib,generated_pb2,*_pb2.py,*_pb2_grpc.py,AntParser,py3",
    "--ignore=E121,E123,E126,E203,E226,E24,E266,E501,E704,W503,W504,I202,"
    "ANN001,ANN002,ANN003,ANN101,ANN201,ANN205,ANN202",
    "--max-line-length=88",
]
...
PYTEST_COMMON_ARGS = ["-vx", "--junitxml=sponge_log.xml"]
